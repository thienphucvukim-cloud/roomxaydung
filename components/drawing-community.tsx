...
export function DrawingCommunity() {
  ...
  const publish = async (event: FormEvent) => {
    ...
    if (!drawingFiles.length) { setNotice("Vui lòng chọn ít nhất một file bản vẽ."); return; }
