...
export function ExploreHeader() {
  ...
  return <header className="social-header sticky top-0 z-50 border-b border-[#e1e7ee] bg-white/95 shadow-[0_1px_8px_rgba(16,40,72,.07)] backdrop-blur-xl">
    <div className="relative mx-auto grid h-[60px] min-h-[60px] max-h-[60px] max-w-[1360px] lg:h-[68px] lg:min-h-[68px] lg:max-h-[68px] grid-cols-[minmax(0,1fr)_auto] items-center gap-3 px-3 sm:px-4 lg:grid-cols-[1fr_minmax(360px,600px)_1fr] lg:px-5">
...
{nav.slice(1).map(([label,href,Icon]) => {
      ...
      <div className="flex min-w-0 items-center justify-end gap-1 sm:gap-1.5">
        ...
        <Link href="/chat" className={`social-icon-button grid ${pathname==="/chat"?"bg-[#dff3fb] text-[#168ac0]":""}`} aria-label="Tin nhắn"><MessageCircle size={20}/></Link>
        <Popover>
